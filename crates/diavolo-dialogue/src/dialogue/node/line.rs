        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for MapVisitor {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let r#type = match discriminator.ok_or(de::Error::custom(
                    "one of 'message', 'choice', or 'confirm' must be present",
                ))? {
                    Discriminator::Message(value) => {
                        use line_type::{LangTexts, Message, MessageOptions, Owner};
                    ...
                    Discriminator::Choice(value) => {
                        use line_type::choice::{Choice, ChoiceOptions, ChoiceTexts};
                        ...
                        LineType::Choice(Choice { texts, options })
                    }
                    Discriminator::Confirm(value) => {
                        ...
                        LineType::Confirm(Confirm { texts, options })
                    }
                };

                Ok(Line { id, r#if, r#type })
            }
        }
